...
- This mirror is source-derived, not a wiki dump — see the verified-keys table below for the MARX5 preset surface.
...
## Verified MARX5 preset surface (2026-05-28)
...
| `aux <slot> <mode> <chan> <lo> <hi> <logic> <link>` | command | mode IDs used by MARX5: 0 ARM, 1 ANGLE, 2 HORIZON, 15 LEDLOW, 35 FLIP_OVER_AFTER_CRASH, 36 PREARM |
